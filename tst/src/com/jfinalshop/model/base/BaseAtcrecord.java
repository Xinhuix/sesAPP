...
public abstract class BaseAtcrecord<M extends BaseAtcrecord<M>> extends Model<M> implements IBean {
	...
	public void setReceivecount(java.math.BigDecimal receivecount) {
		set("receivecount", receivecount);
	}

	public java.math.BigDecimal getReceivecount() {
	...
	public void setOperation(java.lang.Long operation) {
