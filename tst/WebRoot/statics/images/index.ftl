...
<style>
	...
	<div class="mui-content">
		...
		<div class="mui-row member-quick-nav bg-white">
			...
			<a href="${base}/wap/member/message/list.jhtml" class="mui-col-xs-3 item-coupon border-left-s"><span>${messageCount}</span>站内消息</a>
			<a href="${base}/wap/member/coupon_code/list.jhtml" class="mui-col-xs-3 item-balance border-left-s"><span>${currency(member.balance, true, true)}</span>我的钱包</a>
			<a href="${base}/wap/member/deposit/log.jhtml" class="mui-col-xs-3 item-balance border-left-s"><span class="mui-block text-ellipsis" style="text-align:center">
		...
		<ul class="mui-table-view layout-list-common">
			...
			<li class="mui-table-view-cell">
				<a href="#" class="mui-navigate-right">
					...
					<p class="mui-pull-right">查看邀请码</p>
				</a>
			</li>
			<li class="mui-table-view-cell">
				<a href="#" class="mui-navigate-right">
