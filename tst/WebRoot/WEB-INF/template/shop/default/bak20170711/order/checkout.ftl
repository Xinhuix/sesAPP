	...
	<div class="container checkout">
		<div class="row">
			<div class="span12">
				...
				[#if order.isDelivery]
					<form id="receiverForm" action="saveReceiver.jhtml" method="post">
