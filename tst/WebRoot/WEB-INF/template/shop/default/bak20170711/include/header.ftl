...
<div class="header">
	...
	<div class="container">
		<div class="row">
			...
			<div class="span6">
				<div class="search">
					<form id="goodsSearchForm" action="${base}/goods/search.jhtml" method="post">
				...
				<div class="hotSearch">
					[#if setting.hotSearches?has_content]
						...
						[#list setting.hotSearches as hotSearch]
							<a href="javascript:void(0);" onclick="hotSearch('${hotSearch}');">${hotSearch}</a>
						[/#list]
					[/#if]
				</div>
			</div>
