...
[@seo type = "goodsContent"]
	<title>[#if goods.seoTitle??]${goods.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if showPowered] - Powered By JFinalShop[/#if]</title>
				...
				$.ajax({
					...
					success: function(message) {
						if (message.type == "success") {
							location.href = "${base}/order/checkoutExchange.jhtml?type=exchange&productId=" + productId + "&quantity=" + quantity;
						} else {
							$.message(message);
						}
					}
			...
			<div class="span10">
				...
				<div class="productImage">
					[#if goods.productImagesConverter?has_content]
						<a href="${goods.productImagesConverter[0].large}" id="zoom" rel="gallery">
							<img class="medium" src="${goods.productImagesConverter[0].medium}" />
						</a>
					[#else]
				...
				<div id="bar" class="bar">
					<ul>
						...
						[/#if]
						[#if goods.parameterValuesConverter?has_content]
							<li id="parameterTab">
					...
					<div id="review" name="review" class="review">
						...
						<div class="content clearfix">
							[#if goods.scoreCount > 0]
								...
								[@review_list goods_id = goods.id count = 5]
				...
				[#if setting.isConsultationEnabled]
					<div id="consultation" name="consultation" class="consultation">
						...
						<div class="content">
							[@consultation_list goods_id = goods.id count = 5]
