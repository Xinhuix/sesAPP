...
[#if productCategory??]
	[@seo type = "goodsList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if showPowered] - Powered By JFinalShop[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.goods.title")}[#if showPowered] - Powered By JFinalShop[/#if]</title>
	<meta name="author" content="JFinalShop Team" />
	<meta name="copyright" content="JFinalShop" />
[/#if]
