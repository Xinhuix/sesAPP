...
<body>
	<div class="breadcrumb">
		...
		会员卡设置 <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">ID</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="name">卡名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="prefix">级别</a>
				</th>
				<th>
			...
			[#list page.list as card]
				<tr>
					...
					<td>${card.type}</td>					
					<td>
						[#if card.status == '0']  <font color="ff00cc">禁用</font>[/#if]
						[#if card.status == '1'] <font color="33cc99">使用</font>[/#if]
					</td>
					<td>
						<a href="edit.jhtml?id=${card.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
