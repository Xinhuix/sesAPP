...
一级推荐注册返积分比例:
				...
				<td>
<input type="text" name="setting.recommend" class="text" value="${setting.recommend!}" maxlength="200" />%卡面值*数量(第一笔订单),<font color="ff6699">比如：A推荐B，A得5%；B推荐C，B得C的5%，A得C的3%</font>
				</td>
</tr>
<tr>
				<th>
二级推荐注册返积分比例:
				...
				<td>
<input type="text" name="setting.tworecommend" class="text" value="${setting.tworecommend!}" maxlength="200" />%卡面值*数量(第一笔订单)
				</td>
</tr>
<tr>
				<th>
积分提现/余额比例:
				...
				<td>
<input type="text" name="setting.cash" class="text" value="${setting.cash!}" maxlength="200" />如：X:100(X积分/100元)
				</td>
</tr>
...
客服电话:
				...
				<td>
<input type="text" name="setting.hotline" class="text" value="${setting.hotline!}" maxlength="200" />
				</td>
</tr>	
...
搜索关键词:
				...
				<td>
<input type="text" name="setting.keyword" class="text" value="${setting.keyword!}" maxlength="200" />如：蔬菜,水果,大葱
				</td>
</tr>
<tr>
				<th>
关于SES:
				...
				<td>
<textarea id="introduction" name="setting.introduction" class="editor" style="width: 100%;">${setting.introduction!}</textarea>
				</td>
</tr>	
...
推荐页面:
				...
				<td>
<textarea id="tuijian" name="setting.tuijian" class="editor" style="width: 100%;">${setting.tuijian!}</textarea>
				</td>
</tr>	
