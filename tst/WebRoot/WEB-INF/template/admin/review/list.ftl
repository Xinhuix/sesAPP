	...
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="goods_id">${message("Review.goods")}</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="member_id">${message("Review.member")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="is_show">${message("Review.isShow")}</a>
				</th>
				<th>
			...
			[#list page.list as review]
				<tr>
					...
					<td>
						<span title="${review.content}">${abbreviate(review.content, 50, "...")}</span><br>
						[#list review.images?split(",") as image]
							[#if review.images??]
					...
					<td>
						...
						<a href="${base}/admin/review/auditing.jhtml?id=${review.id}">[审核]</a>
					</td>
				</tr>
			[/#list]
		</table>
