...
<title>${message("admin.goods.add")} - Powered By JFinalShop</title>
	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<script>
			  function sc(){
				  	 var s=$("#isdz").val();
				  	 var ct=document.getElementById("cycle_tr");
				  	 var dt=document.getElementById("dz_type");
				   if(s==0){
			...
			<tr>
				...
				<td>
					<select id="isdz" name="goods.is_dz"   onchange="sc()">
					<option value="0" selected>现货</option>
					<option value="1">订制</option>
					</select>
				</td>
			</tr>
			<tr   id="cycle_tr"   style="display:none" >
				<th>定制周期：</th>
				<td style="color:blue;font-weight:bold;">
					<input type="text"  placeholder="默认为0"   name="cycle" />/月
				</td>
			</tr>
			<tr  id="dz_type"  style="display:none">
			<th >定制类型：</th>
			<td>
				<select name="dz_type_id">
...
<tr>
				...
				<td>
					<input type="text" name="goods.origin" class="text" maxlength="200" />
				</td>
</tr>
...
<tr>
				...
				<td>
					<input type="text" name="goods.onlineurl" class="text" maxlength="200" />
				</td>
</tr>			
		<!--	<tr id="number" style="display:none">-->
				...
				<td>
					<input type="text" name="goods.number" class="text" maxlength="200" />
				</td>				
			<!--</tr>-->
		   <tr>
		        <th>
				...
				<td>
					<input type="text" name="goods.sales" class="text" maxlength="200" />
				</td>
		   </tr>			
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="goods.memo" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="goods.seo_title" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="goods.seo_keywords" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="goods.seo_description" class="text" maxlength="200" />
				</td>
			</tr>
		</table>
		<table class="input tabContent">
