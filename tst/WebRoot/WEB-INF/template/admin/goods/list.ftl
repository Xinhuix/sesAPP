...
<title>${message("admin.goods.list")} - Powered By JFinalShop</title>
	...
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="is_dz">现/定</a>
				</th>
				<th>
			...
			[#list page.list as goods]
				<tr>
					...
					<td>
						[#if goods.isdz=='0'] 现货[/#if] [#if goods.isdz=='1'] 定制[/#if]
					</td>				
					<td>
						<img  src="${goods.image!setting.defaultThumbnailProductImage}"  height="60" width="80"><br/>
						<span title="${goods.name}">${abbreviate(goods.name, 50, "...")}</span>
					...
					<td>
						...
						[#if goods.isMarketable]
							...
							<a href="/${base}wap/goods/detail.jhtml?id=${goods.id}" target="_blank">
							[${message("admin.common.view")}]</a>
						[#else]
