...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.ad.list")} <span>(${message("admin.page.total", page.totalRow)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="post">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="ad_position_id">${message("Ad.adPosition")}</a>
				</th>
				<th>
			...
			[#list page.list as ad]
				<tr>
					...
					<td><img  src="${ad.path!setting.defaultThumbnailProductImage}"  height="60" width="80">
