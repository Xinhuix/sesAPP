...
$().ready( function() {
	...
	$captchaImage.click( function() {
		var d = new Date();
		$captchaImage.attr("src", "${base}/admin/common/captcha.jhtml?width=100&height=45&fontsize=30&time=" + d.toString(40));
	});
			...
			<table>
				<tr>
					<td width="190" rowspan="2" align="center" valign="bottom">
						<img src="${base}/resources/admin/images/login_logo.gif" alt="JFinalShop" />
					</td>
					<th>
				...
				[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("adminLogin")]
					<tr>
						...
						<td>
							<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="${base}/admin/common/captcha.jhtml?width=100&height=45&fontsize=30" title="${message("admin.captcha.imageTitle")}" />
						</td>
					</tr>
				[/#if]
				<tr>
				...
				<tr>
					...
					<td>
						...
						<input type="submit" class="loginButton" value="${message("admin.login.login")}" />
					</td>
				</tr>
			</table>
			<div class="powered">COPYRIGHT © 2017-2020 JFINALSHOP.COM ALL RIGHTS RESERVED.</div>
			<div class="link">
				<a href="${base}/">${message("admin.login.home")}</a> |
				<a href="http://www.jfinalshop.com">${message("admin.login.official")}</a> |
				<a href="http://www.jfinalshop.com">${message("admin.login.bbs")}</a> |
				<a href="http://www.jfinalshop.com/about.html">${message("admin.login.about")}</a> |
				<a href="http://www.jfinalshop.com/contact.html">${message("admin.login.contact")}</a> |
				<a href="http://www.jfinalshop.com/license.html">${message("admin.login.license")}</a>
			</div>
		</form>
	</div>
</body>
