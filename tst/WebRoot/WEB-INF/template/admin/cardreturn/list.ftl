...
<body>
	<div class="breadcrumb">
		...
		${message("admin.breadcrumb.home")}</a> &raquo; 月卡退卡管理
...
<input type="text" id="searchValue" name="pageable.searchValue" value="${pageable.searchValue}" maxlength="200" />
		...
		<table id="listTable" class="list">
			<tr>
			    ...
			    <th>
					<a href="javascript:;" class="sort" name="return_date">申请日期</a>
				</th>				
			...
			[#list page.list as o]
				<tr>
					...
					<td>${o.returnDate}</td>					
					<td>
						[#if o.status == '4']  <font color="red">退款申请</font>[/#if]
						[#if o.status == '5'] <font color="green">已退款</font>[/#if]
					</td>
					<td>
					[#if o.status='5']
