...
<body>
	...
	<form id="listForm" action="list.jhtml" method="post">
		...
		<input type="hidden" id="isdz_false" name="isdz_false" value="${(isdz_false?string("true", "false"))!}" />
		<input type="hidden" id="isdz_true" name="isdz_true" value="${(isdz_true?string("true", "false"))!}" />
		<div class="bar">
			<div class="buttonGroup">
				...
				<div id="filterMenu" class="dropdownMenu">
					...
					<ul class="check">
					    ...
					    <li name="isdz_false" [#if isdz_false?? && isdz_false] class="checked"[/#if] val="true">现货</li>
					    <li name="isdz_true" [#if isdz_true?? && isdz_true] class="checked"[/#if] val="true">订制</li>
					</ul>
				</div>
			...
			[#list page.list as order]
				<tr>
					...
					<td>
						...
						<a href="orderreview.jhtml?id=${order.id}">订单追溯</a>
