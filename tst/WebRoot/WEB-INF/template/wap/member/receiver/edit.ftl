		...
		<div class="mui-content">
		    <form name="ajax_district" action="${base}/wap/member/receiver/update.jhtml" method="POST">
		    	...
		    	<div class="padding">
					...
					<button type="submit" class="mui-btn mui-btn-primary full hd-h4 line78">确认修改</button>
		    		<!-- <button type="button" class="margin-top mui-btn mui-btn-primary full hd-h4 site-default">设为默认收货地址</button> -->
		    		<button type="button" class="margin-top mui-btn mui-btn-danger full hd-h4 delete line78">删除收货地址</button>
		    	</div>
		    </form>
		</div>
