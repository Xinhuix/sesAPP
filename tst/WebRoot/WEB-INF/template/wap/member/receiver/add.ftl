		    ...
		    <form name="ajax_district" action="${base}/wap/member/receiver/save.jhtml" method="POST">
		    	<div class="mui-input-group add-address">
			        <div class="mui-input-row">
			            <label>收货人</label>
			            <input type="text" class="mui-input-clear" placeholder="请输入收货人姓名" name="receiver.consignee"/>
			        </div>
			        <div class="mui-input-row">
			            <label>手机号码</label>
		    	...
		    	<div class="padding-lr margin-top">
		    		<button type="submit" class="mui-btn mui-btn-primary full hd-h4 line78">确认添加收货地址</button>
		    	</div>
		    </form>
		</div>
