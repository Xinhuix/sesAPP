[#include "/wap/include/header.ftl" /]
			...
			<ul class="mui-table-view layout-list-common user-info-detail margin-none">
				...
				<li class="mui-table-view-cell">
					<a href="${base}/wap/member/receiver/list.jhtml" class="mui-navigate-right">
						...
						<span class="mui-pull-right margin-right text-gray">地址管理</span>
					</a>
				</li>
				
				<li class="mui-table-view-cell">
					<a href="${base}/wap/member/profile/bankinfo.jhtml" class="mui-navigate-right">
						<span class="hd-h4">银行卡信息</span>
						<span class="mui-pull-right margin-right text-gray">银行卡信息</span>
					</a>
				</li>				
				<!--  
				<li class="mui-table-view-cell">
					<a href="#" class="mui-navigate-right">
						<span class="hd-h4">年龄</span>
						<span class="mui-pull-right margin-right text-gray">年龄管理</span>
					</a>
				</li>
				<li class="mui-table-view-cell">
					<a href="#" class="mui-navigate-right">
						<span class="hd-h4">性别</span>
						<span class="mui-pull-right margin-right text-gray">性别管理</span>
					</a>
				</li>
				<li class="mui-table-view-cell">
					<a href="#" class="mui-navigate-right">
						<span class="hd-h4">职业</span>
						<span class="mui-pull-right margin-right text-gray">职业管理</span>
					</a>
				</li>-->
			</ul>
		</div>
 ...
 //$.tips({content:'上传失败失sssss',delayTime:5000})
//window.location.href='${base}/wap/member/profile/edit.jhtml';
//$.tips({content:'上传失败失败失败失败'}).slideUp(300).delay(5000).fadeIn(400);
//$.tips({content: '上传失败失败失败失败',5});
/*
setTimeout(function(){
                $.tips.hide();
