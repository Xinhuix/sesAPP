	...
	<div class="mui-content">
	    <div class="logistics-company padding">
	    	<div class="mui-pull-left margin-right">
	    		<img src="${base}/statics/images/deliverys/wuliu.gif"/>
	    	</div>
	    ...
	    <div class="list-col-10 padding-lr">
	    	...
	    	[#if order?? && order.shippings?has_content]
				...
				<iframe width="100%;" height="500" src="https://m.kuaidi100.com/result.jsp?com=shentong&nu=[#if order?? && order.shippings?has_content] ${order.shippings[0].trackingNo} [#else] - [/#if]" ></iframe>
				<!--
