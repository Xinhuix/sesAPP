...
[@seo type = "articleSearch"]
	<title>[#if seo.title??][@seo.title?interpret /][/#if][#if showPowered] - Powered By JFinalShop[/#if]</title>
	...
	<div class="container articleList">
		<div class="row">
			...
			<div class="span10">
				...
				[@pagination pageNumber = page.pageNumber totalPages = page.totalPage pattern = "search.jhtml?keyword=${articleKeyword?url}&pageNumber={pageNumber}"]
