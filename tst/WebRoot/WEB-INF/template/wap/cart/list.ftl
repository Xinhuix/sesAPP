[#include "/wap/include/header.ftl" /]
					...
					[#list cart.cartItems as cartItem]
				    	<dd class="cart-list-item" data-skuid="${cartItem.product.id}" data-id="${cartItem.id}">
			    			...
			    			<div class="item-text">
								...
								<br/>
								<span style='font-size:.24rem;'>现货商品</span>
			    				<div class="number mui-clearfix car_ctr">
	...
	<div class="mui-content">
		<ul class="user-lists mui-clearfix">
	    	<li class="user-list-none order-lh-40 mui-text-center" style="padding-top:1.92rem;">
				
				<p class="text-black hd-h4"><i class="no_goods"></i>您的购物车里没有商品</p>
				<a href="${base}/wap/index.jhtml" class="mui-btn mui-btn-primary mui-btn-outlined border-small">去购物</a>
			</li>
		</ul>
	</div>
	[/#if]
