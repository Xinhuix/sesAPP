			...
			<div class="mui-content">
				<div class="padding login-wrap">
					<form class="padding-small" action="${base}/wap/login/submit.jhtml" method="POST" name="login_form">
						<div class="list">
	<input type="tel" class="input" name="username" value="${temp_Username!}" placeholder="请输入手机号" datatype="s2-15|mobile|email" nullmsg="请输入手机号" errmsg="格式不正确">
							<span class="validform_checktip"></span></div>
						<div class="list">
							<input type="password" class="input" name="password" placeholder="请输入登录密码" datatype="*" nullmsg="请输入密码">
							<span class="validform_checktip"></span></div>
						<input type="submit" class="mui-btn full line78" value="登录">
						<a class="mui-btn full margin-top margin-bottom mui-btn-danger" href="${base}/wap/register/register.jhtml" style="color: #259b24;">还没有账号？注册</a>
						<div class="mui-clearfix">
							<input type="hidden" name="url_forward" value="">
							<label class="mui-pull-left text-gray"><input type="checkbox" checked="checked"> 记住登录名</label>
